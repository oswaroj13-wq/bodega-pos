...
app = Flask(__name__)
# Usa una variable de entorno en Render o una clave por defecto en desarrollo
app.secret_key = os.environ.get("SECRET_KEY", "secreto_bodega_pos_pydroid")

# Ruta absoluta para asegurar la base de datos en la raíz del proyecto
...
# Inicializa la base de datos automáticamente al cargar la app en Render
init_db()
...
def despachar():
    ...
    try:
        ...
        conn.rollback()
        print("Error al despachar:", str(e))
